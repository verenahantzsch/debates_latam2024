...
# creamos log de gol_enpres 

base_elecciones <- base_elecciones %>% 
  mutate(log_gol_enpres = log(gol_enpres))
...
hist(base_elecciones$gol_enpres)
...
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_debates_eleccion), gol_enpres))
# sistema mas fraccionado cuando hay debates, aunque diferencia parece menor
modelo <- glm(dico_debates_eleccion ~ gol_enpres,
...
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_debates_eleccion), log_gol_enpres))
# no parece haber tanta diferencia respecto de no-log, pero no se si estoy interpretando bien
modelo <- glm(dico_debates_eleccion ~ log_gol_enpres,
              data = base_elecciones,
              family = "binomial")
summary(modelo)

# cruce LOG con DICO FRONTRUNNER
mean_values <- aggregate(log_gol_enpres ~ dico_frontrunner_presente, base_elecciones, mean, na.rm = TRUE)
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_frontrunner_presente), log_gol_enpres))
# idem
modelo <- glm(dico_frontrunner_presente ~ log_gol_enpres,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
hist(base_elecciones$log_competitividad) # tiene mas sentido. 
...
modelo <- glm(dico_debates_eleccion ~ competitividad,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
modelo <- glm(dico_debates_eleccion ~ log_competitividad,
              data = base_elecciones,
              family = "binomial")
summary(modelo)

# cruce con DICO_FRONTRUNNER

mean_values <- aggregate(competitividad ~ dico_frontrunner_presente, base_elecciones, mean, na.rm = TRUE)
# idem, hay mas competitividad (menos dif entre candidatos) cuando hay debates, la diferencia es muy ligeramente mas amplia
...
modelo <- glm(dico_frontrunner_presente ~ competitividad,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
modelo <- glm(dico_frontrunner_presente ~ log_competitividad,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
modelo <- glm(dico_debates_eleccion ~ concentracion,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
modelo <- glm(dico_frontrunner_presente ~ concentracion,
              data = base_elecciones,
              family = "binomial")
summary(modelo)

# REGULACION version continua #####################
...
# pero tambien hay mas variabilidad cuando hay debates, si estoy leyendo bien
modelo <- glm(dico_debates_eleccion ~ ncat_totreg,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
# idem
modelo <- glm(dico_frontrunner_presente ~ ncat_totreg,
              data = base_elecciones,
              family = "binomial")
summary(modelo)

# CONFIANZA EN MEDIOS #############################
# PENDIENTE PENSAR: NO CONVIENE HACER UN ESCALADO DE CONFIANZA RELATIVA MEDIOS --PPOLS ? 

# LAPOP / LATINOBAROMETRO VERSION INTERPOLADA   
# distrib univariada 
...
# hay mas confianza en medios cuando hay debates. recordar que escala va de 0 a 4
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_debates_eleccion), int_average_confianza_tv_medios_latin_lapop))
modelo <- glm(dico_debates_eleccion ~ int_average_confianza_tv_medios_latin_lapop,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
# hay mas confianza cuando hay debates tambien, diferencia es ligeramente menor 
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_frontrunner_presente), int_average_confianza_tv_medios_latin_lapop))
modelo <- glm(dico_frontrunner_presente ~ int_average_confianza_tv_medios_latin_lapop,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
# hay menos confianza alli donde no hay debates. poca diferencia
...
modelo <- glm(dico_debates_eleccion ~ int_average_scaled_confianza_tv_medios_latin_lapop,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
# diferencia se invierte. sigue siendo pequeña. mas desconfianza donde si hay debates
...
modelo <- glm(dico_frontrunner_presente ~ int_average_scaled_confianza_tv_medios_latin_lapop,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_debates_eleccion), wvs_confpr))
modelo <- glm(dico_debates_eleccion ~ wvs_confpr,
              data = base_elecciones,
              family = "binomial")
summary(modelo) # a menos confianza, mas proba de debates, no sficativa 

# cruce con DICO FRONTRUNNER
mean_values <- aggregate(wvs_confpr ~ dico_frontrunner_presente, base_elecciones, mean, na.rm = TRUE)
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_frontrunner_presente), wvs_confpr))
modelo <- glm(dico_frontrunner_presente ~ wvs_confpr,
              data = base_elecciones,
              family = "binomial")
summary(modelo) # idem 
...
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_debates_eleccion), wvs_conftv))
modelo <- glm(dico_debates_eleccion ~ wvs_conftv,
              data = base_elecciones,
              family = "binomial")
summary(modelo) # a menos confianza, mas proba de debates, no sficativa 

# cruce con DICO FRONTRUNNER
mean_values <- aggregate(wvs_conftv ~ dico_frontrunner_presente, base_elecciones, mean, na.rm = TRUE)
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_frontrunner_presente), wvs_conftv))
modelo <- glm(dico_frontrunner_presente ~ wvs_conftv,
              data = base_elecciones,
              family = "binomial")
summary(modelo) # idem 
...
modelo <- glm(dico_debates_eleccion ~ int_average_confianza_ppols,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
modelo <- glm(dico_frontrunner_presente ~ int_average_confianza_ppols,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
modelo <- glm(dico_debates_eleccion ~ lagged_all_previous_elec,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
modelo <- glm(dico_debates_eleccion ~ lagged_all_previous_elec_frontrunner_presente,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
modelo <- glm(dico_frontrunner_presente ~ lagged_all_previous_elec,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
modelo <- glm(dico_frontrunner_presente ~ lagged_all_previous_elec_frontrunner_presente,
              data = base_elecciones,
              family = "binomial")
summary(modelo)

# las diferencias entre las outcome variables alternativas están para pensar.
# pareceria que frontrunner son mas fuertes en marcar tendencia futura
# ojo que MUCHOS missings 

# CUMSUM DE N TOT DEBATES PASADOS n: tot debates en pasadas elec 
# PENDIENTE VERSION LOG DE ESTA VARIABLE, SI SE USA
...
modelo <- glm(dico_debates_eleccion ~ lagged_all_previous_debates,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
modelo <- glm(dico_debates_eleccion ~ lagged_all_previous_debates_frontrunner_presente,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
modelo <- glm(dico_frontrunner_presente ~ lagged_all_previous_debates,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
modelo <- glm(dico_frontrunner_presente ~ lagged_all_previous_debates_frontrunner_presente,
              data = base_elecciones,
              family = "binomial")
summary(modelo)

# idem observaciones anteriores 
...
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_debates_eleccion), prop_elecciones_año_anterior_region_con_debates))
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_debates_eleccion), prop_elecciones_año_anterior_region_con_frontrunner))
modelo <- glm(dico_debates_eleccion ~ prop_elecciones_año_anterior_region_con_debates,
              data = base_elecciones,
              family = "binomial")
summary(modelo) # coeficiente en tamaño parecido al de historia propia visto arriba, pero ojo que escalas de medicion son diferentes
modelo <- glm(dico_debates_eleccion ~ prop_elecciones_año_anterior_region_con_frontrunner,
              data = base_elecciones,
              family = "binomial")
summary(modelo)

# cruce con  DICO FRONTRUNNER
mean_values <- aggregate(prop_elecciones_año_anterior_region_con_debates ~ dico_frontrunner_presente, base_elecciones, mean, na.rm = TRUE)
mean_values <- aggregate(prop_elecciones_año_anterior_region_con_frontrunner ~ dico_frontrunner_presente, base_elecciones, mean, na.rm = TRUE)
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_frontrunner_presente), prop_elecciones_año_anterior_region_con_debates)) 
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_frontrunner_presente), prop_elecciones_año_anterior_region_con_frontrunner))
modelo <- glm(dico_frontrunner_presente ~ prop_elecciones_año_anterior_region_con_debates,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
modelo <- glm(dico_frontrunner_presente ~ prop_elecciones_año_anterior_region_con_frontrunner,
              data = base_elecciones,
              family = "binomial")
summary(modelo)
...
modelo <- glm(dico_debates_eleccion ~ mean_prop_elecciones_con_debates_periodo_previo,
              data = base_elecciones,
              family = "binomial")
summary(modelo)

mean_values <- aggregate(mean_prop_elecciones_con_debates_periodo_previo ~ dico_frontrunner_presente, base_elecciones, mean, na.rm = TRUE)
# idem, y distancia se agranda ligeramente
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_frontrunner_presente), mean_prop_elecciones_con_debates_periodo_previo))
modelo <- glm(dico_frontrunner_presente ~ mean_prop_elecciones_con_debates_periodo_previo,
              data = base_elecciones,
              family = "binomial")
summary(modelo) # crece todavia mas coeficiente, de nuevo ojo que hay missing

# VARIABLES DE CONTROL : EDAD DE REGIMEN #######
...
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_debates_eleccion), bmr_demdur))
modelo <- glm(dico_debates_eleccion ~ log(bmr_demdur),
              data = base_elecciones,
              family = "binomial")
summary(modelo) # regimen mas antiguo cuando hay debates , no sficativo salvo en version log 

# # cruce con DICO FRONTRUNNER
mean_values <- aggregate(bmr_demdur ~ dico_frontrunner_presente, base_elecciones, mean, na.rm = TRUE)
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_frontrunner_presente), bmr_demdur))
modelo <- glm(dico_frontrunner_presente ~ log(bmr_demdur),
              data = base_elecciones,
              family = "binomial")
summary(modelo) # idem anterior 

# alternativo # 4 .77.1 Regime Durability (p_durable) Regime Durability: 
...
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_debates_eleccion), p_durable)) # outlier es del caso sin debates
modelo <- glm(dico_debates_eleccion ~ p_durable,
              data = base_elecciones,
              family = "binomial")
summary(modelo) # regimen mas antiguo cuando hay debates  

# # cruce con DICO FRONTRUNNER
mean_values <- aggregate(p_durable ~ dico_frontrunner_presente, base_elecciones, mean, na.rm = TRUE)
ggplot(base_elecciones) + geom_boxplot(aes(as.factor(dico_frontrunner_presente), p_durable))
modelo <- glm(dico_frontrunner_presente ~  p_durable ,
              data = base_elecciones,
              family = "binomial")
summary(modelo) # idem anterior 
