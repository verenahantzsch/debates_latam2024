...
plot_ncat_competencia_por_pais <- ncat_competencia_por_pais %>% 
  ggplot() +
  geom_point(aes(cat_pais, mean_ncat_competencia_pais)) +
  geom_line(aes(cat_pais, mean_ncat_competencia_pais)) +
  geom_smooth(aes(cat_pais, mean_ncat_competencia_pais)) +
  theme_minimal()
...
plot_ncat_ppac_por_pais <- ncat_ppac_por_pais %>% 
  ggplot() +
  geom_point(aes(cat_pais, mean_ncat_ppac_pais)) +
  geom_line(aes(cat_pais, mean_ncat_ppac_pais)) +
  geom_smooth(aes(cat_pais, mean_ncat_ppac_pais)) +
  theme_minimal()
