...
# ABRO DATA POR ENCUESTA ACTUALIZADA, original + cantu + propia 

full_dataset <- read.csv("/home/carolina/Documents/dataexterna/Carrera_Cantu_datos_debates_completo/polls_completo_marzo2024_cantuYcarolina.csv")
